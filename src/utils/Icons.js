...
export const list = <i className="fa-solid fa-star"></i>;
...
export const todo = <i className="fa-solid fa-exclamation"></i>;
...
export const cross = <i className="fa-solid fa-times"></i>;
export const minor = <i className="fa-solid fa-question"></i>
